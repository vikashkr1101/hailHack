...
<head>
    ...
    <!-- Page Title -->
    <title>HailHACK-Customer Report</title>
...
<body>
    ...
    <div class="navbar">
        <nav>
            <div class="brand">
                ...
                <a  class="nav-item active" href="index.php">Logout
    ...
    <section id="mybooking">
        <h1 style="font-size:2.5rem;">Customers Report</h1>
        <h3 style="border:2px solid white;margin-left: 46%;width: 8%;
             margin-top: 1rem;"><?php echo $rowcount ?>  Customers</h3>
    </br></br>
