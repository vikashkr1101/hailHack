...
<body style="background-color: black;
 ...
 <nav>
     <div class="brand">
         ...
         <a class="nav-item" href="mybooking.php">Back</a>
...
<footer class="main-block dark-bg">
    ...
    if(isset($_REQUEST['change']))
    {
        ...
        $query = mysqli_query($conn,"SELECT * from driver_register where email='$email'");
        ...
        else
        {
            ...
            {
                $res="UPDATE driver_register SET password='$pass2' where email='$email'";
                $n=iud($res);
